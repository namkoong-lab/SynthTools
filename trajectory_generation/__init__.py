...
A *task* is one row of `task_content.jsonl` (id, summary, tools, gt_tool_calls,
initial_state, final_state). Calling `generate_trajectory(task, llm, ...)` runs the existing
